...
"augroup Shebang
"   autocmd BufNewFile *.py 0put =\"#!/usr/bin/env python\<nl># -*- coding: utf-8  -*-\<nl># Author: Diogenes <diogenes.rj@tutonota.com>\"|$
"   autocmd BufNewFile *.pl 0put =\"#!/usr/bin/env perl\<nl># -*- coding: None -*-\<nl># Author: Diogenes <diogenes.rj10@tutanota.com>\"|$
"   autocmd BufNewFile *.sh 0put =\"#!/usr/bin/env bash\<nl># -*- coding: None -*-\<nl># Author: Diogenes <diogenes.rj10@tutanota.com>\"|$
" augroup END
