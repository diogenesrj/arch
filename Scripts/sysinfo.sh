...
GtkTheme=$(awk < .gtkrc-2.0 -F'/' '/include/{print $5}')
GtkIcon=$(awk < .gtkrc-2.0 -F'/' '/include/{print $5}' )
GtkFont=$(awk < .gtkrc-2.0 -F'"' '/font_name/{print $2}')
...
Monitor=$(awk < /var/log/Xorg.0.log '/Display/{print $6,$7}'|tr -d '()'|sed -n '1p')
 ...
 echo  ""
 echo -e "\e[96m   ////////////////////"
 echo "   INFORMAÇAO DO SYSTEMA"
 echo "   ////////////////////"
 echo  ""
 echo -e "\e[96m    \e[30m  \e[96ms373 "
 echo -e "\e[90m    \e[30m \e[39m$MODEL"
 echo -e "\e[90m    \e[30m \e[39m$OS $ARCH"
 echo -e "\e[90m    \e[30m \e[39m$KERNEL"
 echo -e "\e[90m    \e[30m \e[39m$UPTIME"
 echo -e "\e[90m    \e[30m \e[39m$SHELL"
 echo -e "\e[90m    \e[30m \e[39m$RESOLUTION"
 echo -e "\e[90m    \e[30m \e[39m$CPU"
 echo -e "\e[90m    \e[30m \e[39m$GPU"
 echo -e "\e[96m   ////////////////////"
 echo -e "\e[90m    \e[30m \e[31m$DE"
 echo -e "\e[90m    \e[30m \e[39m$GtkTheme"
 echo -e "\e[90m    \e[30m \e[39m$GtkIcon"
 echo -e "\e[90m    \e[30m \e[39m$GtkFont"
 echo -e "\e[90m    \e[30m \e[39m$BIRTH"
 echo -e "\e[96m   ////////////////////"
 echo -e "\e[90m    \e[30m \e[31m$Packages"
 echo -e "\e[90m    \e[30m \e[39m$Layout"
 echo -e "\e[90m    \e[30m \e[39m$Monitor"
 echo -e "\e[96m                                "
 echo  ""
